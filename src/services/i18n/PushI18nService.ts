...
type EventType =
  ...
  | 'chat_ring_ack'; // 被呼叫方「正準備回覆」通知呼叫方（routes/chatCalls.ts）
...
const HARDCODED_FALLBACK: Record<EventType, PushString> = {
  ...
  chat_ring: { title: '📞 {callerName} 正在呼叫你', body: '點這則通知，讓對方知道你正準備回覆' },
  chat_ring_ack: { title: '✅ {calleeName} 正準備回覆', body: '對方已看到你的呼叫，請稍候' },
};
