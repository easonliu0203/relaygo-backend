-- ============================================
-- 檢查錯誤訊息（Supabase Dashboard 版本）
-- ============================================
-- 
-- 用途：查看 outbox 事件的錯誤訊息，診斷失敗原因
-- 適用於：Supabase Dashboard SQL Editor
-- 
-- ============================================

-- 檢查 1: 最近的錯誤事件
SELECT '=== 檢查 1: 最近的錯誤事件 ===' as info;
...
SELECT '=== 解讀說明 ===' as info;
SELECT 
  'first_attempt: 第一次嘗試失敗的事件' as explanation
UNION ALL
SELECT 'second_attempt: 第二次嘗試失敗的事件'
UNION ALL
SELECT 'third_attempt: 第三次嘗試失敗的事件'
UNION ALL
SELECT 'max_retries: 已達到最大重試次數（不會再處理）';
