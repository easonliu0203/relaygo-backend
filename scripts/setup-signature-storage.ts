/**
 * 設置 Supabase Storage bucket 用於儲存支付簽名圖片
 * 
 * 執行方式：
 * npx ts-node scripts/setup-signature-storage.ts
 */
...
async function setupSignatureStorage() {
  console.log('🚀 開始設置 Supabase Storage bucket...\n');
